...
\begin{document}
    ...
    In Figure~\ref{fig:bar-1998-2004} ist die absolute Verteilung von Regeln in die beiden Kategorien \enquote{Empfohlene}
    sowie \enquote{Verpflichtende} aufgetragen.
    Im dritten Balkenpaar sind die Gesamtanzahlen der Regeln aufgetragen.
    In Figure~\ref{fig:pie-1998-2004} sind die prozentualen Anteile der beiden Regelkategorien aufgetragen.
    ...
    Dies geht einher mit den Zielen von M2004, große Regeln in mehrere kleinere aufzuteilen um diese leichter zu entscheiden
    und verstehen zu machen, sowie den Fokus auf die verpflichtenden, also die \enquote{essentielleren} Regeln zu verschieben.
