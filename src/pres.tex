    ...
    \begin{frame}{Signal-Rausch-Verhältnis}
        \begin{center}
            \begin{overprint}
                ...
                Transgression rates in warnings per 1000 lines of source code (KLOC) on 7 packages using MISRA C1 (1998).
                }
                \only<2> {
                \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphics/2004-transgression-rates.png}
                Transgression rates in warnings per 1000 lines of source code (KLOC) on 7 packages using MISRA C2 (2004).
                }
            \end{overprint}
        \end{center}
    \end{frame}
