...
\begin{document}
    ...
    \begin{frame}{Regelsatz 1998}
        \begin{center}
            \include{graphics/pie1998}
        \end{center}
    \end{frame}

    \begin{frame}{Regelsatz 2004}
        \begin{center}
            \include{graphics/pie2004}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Subjektive Regeln}
        ...
        \only<3> {
            \begin{exampleblock}{Rule X.X (required)} %TODO INSERT RULE NAME
    ...
    \begin{frame}{Gütekriterien}
        \begin{itemize}
            ...
            \item Regelentscheidbarkeit
            \item Regelatomizität
            \item Regelgewichtung
    ...
    \begin{frame}{Regelorthogonalität}
        \begin{center}
            \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{graphics/rule-crosstalk.pdf}
        \end{center}
    \end{frame}
